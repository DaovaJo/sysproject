...
f = 1
teacher = "Блощук Андрей Алексеевич"
d = 11
...
def search(f):
    ...
    for i in forEvent:   
            ...
            file =r'C:\Users\ddaova\Desktop\работа\июнь нагрузка' + i + str(f) + r' июня 2022 г.XLSX'
            print(file)
            # print(x)
            ...
            for Data, Time, Class, Subjects, none, Group, Event, Teach, Com, Coment, Output, Departmant in cells:
                cc = list()       
                if Teach.value == teacher and Departmant.value == "Кафедра информационных систем": #and Departmant.value == 'Кафедра информационных систем':
                    Data = Data.value
